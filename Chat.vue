    ...
    <div class="chat-wrapper">
        <div class="chatbox" v-if="showChat">
            <div class="messages" :key="updateCount">
                <Message v-for="(msg, index) in getMessages" :key="index" :message="msg"
                    :useTimestamps="chatbox.timestamp" :fade="chatbox.shouldFade" :msgSize="chatbox.msgLength" />
            </div>
            ...
            <div class="input-holder">
                <!-- Chat Input Box -->
                <Input @input="handleInput" v-model="userInput" @suggestion-tab="handleSuggestionTab"
                    :style="getInputStyle" />
                <!-- Chat Suggestions -->
                <Suggestions v-if="suggestions.length >= 1" :suggestions="suggestions"
...
export default defineComponent({
    ...
    methods: {
        ...
        isLocalCommand(message: string): boolean {
            if (message === '/clear' && 'alt' in window) {
...
.chatbox {
    ...
    min-width: 450px;
    min-height: 336px;
    /* Font Size + Message Margin Bottom * Page Size */
    max-height: 336px;
    /* Font Size + Message Margin Bottom * Page Size */
    margin-left: 1vw;
    margin-top: -20vh;
